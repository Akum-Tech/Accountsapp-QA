...
exports.encreptionBank = exports.decreptionBank = void 0;
...
var key = '';
var encreptionBank = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _context.t0 = data.bank_name !== '';
        case 6:
          if (!_context.t0) {
            _context.next = 10;
            break;
          }
          _context.t1 = encrypt(data.bank_name).toString();
          _context.next = 11;
          break;
        case 10:
          _context.t1 = '';
        case 11:
          data.bank_name = _context.t1;
          _context.next = 14;
        ...
        case 14:
          ...
          _context.t2 = data.bank_account_number !== '';
        case 17:
          if (!_context.t2) {
            _context.next = 21;
            break;
          }
          _context.t3 = encrypt(data.bank_account_number).toString();
          _context.next = 22;
          break;
        case 21:
          _context.t3 = '';
        case 22:
          data.bank_account_number = _context.t3;
          _context.next = 25;
        ...
        case 25:
          ...
          _context.t4 = data.bank_ifsc !== '';
        case 28:
          if (!_context.t4) {
            _context.next = 32;
            break;
          }
          _context.t5 = encrypt(data.bank_ifsc).toString();
          _context.next = 33;
          break;
        case 32:
          _context.t5 = '';
        case 33:
          data.bank_ifsc = _context.t5;
  ...
  return function encreptionBank(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.encreptionBank = encreptionBank;
var decreptionBank = /*#__PURE__*/function () {
  ...
  return function decreptionBank(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
exports.decreptionBank = decreptionBank;
