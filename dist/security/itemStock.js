...
exports.encreptionItem = exports.decreptionItem = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _context.t0 = data.quantity !== '';
        case 6:
          if (!_context.t0) {
            _context.next = 10;
            break;
          }
          _context.t1 = encrypt(data.quantity.toString()).toString();
          _context.next = 11;
          break;
        case 10:
          _context.t1 = '';
        case 11:
          data.quantity = _context.t1;
          _context.next = 14;
          return data.name;
        case 14:
          ...
          _context.t2 = data.name !== '';
        case 17:
          if (!_context.t2) {
            _context.next = 21;
            break;
          }
          _context.t3 = encrypt(data.name).toString();
          _context.next = 22;
          break;
        case 21:
          _context.t3 = '';
        case 22:
          data.name = _context.t3;
          _context.next = 25;
        ...
        case 25:
          ...
          _context.t4 = data.description !== '';
        case 28:
          if (!_context.t4) {
            _context.next = 32;
            break;
          }
          _context.t5 = encrypt(data.description).toString();
          _context.next = 33;
          break;
        case 32:
          _context.t5 = '';
        case 33:
          data.description = _context.t5;
          _context.next = 36;
          return data.model;
        case 36:
          ...
          _context.t6 = data.model !== '';
        case 39:
          if (!_context.t6) {
            _context.next = 43;
            break;
          }
          _context.t7 = encrypt(data.model).toString();
          _context.next = 44;
          break;
        case 43:
          _context.t7 = '';
        case 44:
          data.model = _context.t7;
          _context.next = 47;
        ...
        case 47:
          ...
          _context.t8 = data.hsn_code !== '';
        case 50:
          if (!_context.t8) {
            _context.next = 54;
            break;
          }
          _context.t9 = encrypt(data.hsn_code).toString();
          _context.next = 55;
          break;
        case 54:
          _context.t9 = '';
        case 55:
          data.hsn_code = _context.t9;
          _context.next = 58;
          return data.price;
        case 58:
          ...
          _context.t10 = data.price !== '';
        case 61:
          if (!_context.t10) {
            _context.next = 65;
            break;
          }
          _context.t11 = encrypt(data.price.toString()).toString();
          _context.next = 66;
          break;
        case 65:
          _context.t11 = '';
        case 66:
          data.price = _context.t11;
          _context.next = 69;
        ...
        case 69:
          ...
          _context.t12 = data.discount !== '';
        case 72:
          if (!_context.t12) {
            _context.next = 76;
            break;
          }
          _context.t13 = encrypt(data.discount.toString()).toString();
          _context.next = 77;
          break;
        case 76:
          _context.t13 = '';
        case 77:
          data.discount = _context.t13;
          _context.next = 80;
        ...
        case 80:
          ...
          _context.t14 = data.total_amount !== '';
        case 83:
          if (!_context.t14) {
            _context.next = 87;
            break;
          }
          _context.t15 = encrypt(data.total_amount.toString()).toString();
          _context.next = 88;
          break;
        case 87:
          _context.t15 = '';
        case 88:
          data.total_amount = _context.t15;
