...
exports.encreptionItem = exports.decreptionItemAmount = exports.decreptionItem = void 0;
...
var key = '';
var encreptionItem = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 14:
          ...
          _context.t2 = data.hsn_code !== '';
        case 17:
          if (!_context.t2) {
            _context.next = 21;
            break;
          }
          _context.t3 = encrypt(data.hsn_code).toString();
          _context.next = 22;
          break;
        case 21:
          _context.t3 = '';
        case 22:
          data.hsn_code = _context.t3;
          _context.next = 25;
          return data.rate;
        case 25:
          ...
          _context.t4 = data.rate !== '';
        case 28:
          if (!_context.t4) {
            _context.next = 32;
            break;
          }
          _context.t5 = encrypt(data.rate.toString()).toString();
          _context.next = 33;
          break;
        case 32:
          _context.t5 = '';
        case 33:
          data.rate = _context.t5;
          _context.next = 36;
        ...
        case 36:
          ...
          _context.t6 = data.quantity !== '';
        case 39:
          if (!_context.t6) {
            _context.next = 43;
            break;
          }
          _context.t7 = encrypt(data.quantity).toString();
          _context.next = 44;
          break;
        case 43:
          _context.t7 = '';
        case 44:
          data.quantity = _context.t7;
          _context.next = 47;
        ...
        case 47:
          ...
          _context.t8 = data.total_value !== '';
        case 50:
          if (!_context.t8) {
            _context.next = 54;
            break;
          }
          _context.t9 = encrypt(data.total_value.toString()).toString();
          _context.next = 55;
          break;
        case 54:
          _context.t9 = '';
        case 55:
          data.total_value = _context.t9;
          _context.next = 58;
        ...
        case 58:
          ...
          _context.t10 = data.cess_tax !== '';
        case 61:
          if (!_context.t10) {
            _context.next = 65;
            break;
          }
          _context.t11 = encrypt(data.cess_tax).toString();
          _context.next = 66;
          break;
        case 65:
          _context.t11 = '';
        case 66:
          data.cess_tax = _context.t11;
  ...
  return function encreptionItem(_x) {
    return _ref.apply(this, arguments);
  };
}();
exports.encreptionItem = encreptionItem;
var decreptionItem = /*#__PURE__*/function () {
  ...
  return function decreptionItem(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
exports.decreptionItem = decreptionItem;
var decreptionItemAmount = /*#__PURE__*/function () {
  ...
  return function decreptionItemAmount(_x5, _x6, _x7) {
    return _ref3.apply(this, arguments);
  };
}();
exports.decreptionItemAmount = decreptionItemAmount;
