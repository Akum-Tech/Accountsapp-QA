...
var _company = _interopRequireDefault(require("../services/company.service"));
var _company2 = require("../validation/company");
var _statusCode = require("../utility/statusCode");
var _company3 = require("../security/company");
...
function getCompanys(_x, _x2) {
  return _getCompanys.apply(this, arguments);
}
function _getCompanys() {
  _getCompanys = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var getdata;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return _company["default"].getAllData(req.body, res);
        case 4:
...
function _getCompany() {
  _getCompany = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var createdata;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 9:
          req.body.data = req.decoded.data;
          _context2.next = 12;
          return _company["default"].getSingleData(req.params.id, req.body, res);
        case 12:
...
function _createCompany() {
  _createCompany = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return (0, _company2.createCompanyValidation)(req.body);
        case 3:
        ...
        case 8:
          req.body.company_logo = _context3.sent;
          _context3.next = 12;
          break;
        case 11:
        ...
        case 14:
          ...
          _context3.next = 17;
          return (0, _company3.encreption)(req.body);
        case 17:
          data = _context3.sent;
          if (!data) {
            _context3.next = 23;
          ...
          _context3.next = 21;
          return _company["default"].createData(data, res);
        case 21:
...
function _deleteCompany() {
  _deleteCompany = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var deletedata;
...
function _updateCompany() {
  _updateCompany = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var data, updatedata;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 7:
          ...
          _context5.next = 11;
          return _company["default"].updateData(req.params.id, data, res);
        case 11:
...
function updatePeriod(_x11, _x12) {
  return _updatePeriod.apply(this, arguments);
}
function _updatePeriod() {
  _updatePeriod = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var updatedata;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          req.body.data = req.decoded.data;
          _context6.next = 5;
          return _company["default"].updatePeriodDate(req.body, res);
        case 5:
        ...
        case 17:
          ...
          _context6.t4 = res.status(500);
          _context6.next = 22;
          return (0, _statusCode.checkCode)('error');
        case 22:
          _context6.t5 = _context6.sent;
          _context6.t6 = _context6.t3;
          _context6.t7 = {
...
function updatemanualstock(_x13, _x14) {
  return _updatemanualstock.apply(this, arguments);
}
function _updatemanualstock() {
  _updatemanualstock = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var updatedata;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          ...
          req.body.data = req.decoded.data;
          _context7.next = 5;
          return _company["default"].updateMaualstock(req.body, res);
        case 5:
        ...
        case 17:
          ...
          _context7.t4 = res.status(500);
          _context7.next = 22;
          return (0, _statusCode.checkCode)('error');
        case 22:
          _context7.t5 = _context7.sent;
          _context7.t6 = _context7.t3;
          _context7.t7 = {
            statusCode: _context7.t5,
            error: _context7.t6,
            success: false,
            message: "Something went wrong!"
          };
          _context7.t4.json.call(_context7.t4, _context7.t7);
        case 26:
        case "end":
