...
var _forgetPassword = _interopRequireDefault(require("../services/forgetPassword.service"));
require("@babel/polyfill");
var _forgetPassword2 = require("../validation/forgetPassword");
...
function genrateOtp(_x, _x2) {
  return _genrateOtp.apply(this, arguments);
}
function _genrateOtp() {
  _genrateOtp = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _forgetPassword2.forgetPasswordValidation)(req.body);
        case 3:
          ...
          _context.next = 7;
          return _forgetPassword["default"].genrateOtp(req.body, res);
        case 7:
...
function _verifyOtp() {
  _verifyOtp = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var validation, checkdata;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return (0, _forgetPassword2.verifyOtpValidation)(req.body);
        case 3:
          ...
          _context2.next = 7;
          return _forgetPassword["default"].verifyotp(req.body, res);
        case 7:
...
function _UpdatePassword() {
  _UpdatePassword = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return (0, _forgetPassword2.updatePasswordValidation)(req.body);
        case 3:
          ...
          _context3.next = 7;
          return _forgetPassword["default"].updateData(req.params.id, req.body, res);
        case 7:
