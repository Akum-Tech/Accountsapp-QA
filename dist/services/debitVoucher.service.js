    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _context.next = 7;
          return (0, _debitvoucher.decreptionDebit)(createdata, 'object', data.data.email);
        case 7:
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          _context3.next = 7;
          return (0, _debitvoucher.decreptionDebit)(createdata, 'array', data.data.email);
        case 7:
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _debitVoucher["default"].findAndCountAll({
            limit: data.limit,
            offset: data.offset,
            where: {
              company_id: data.company_id,
        ...
        case 3:
          ...
          _context4.next = 7;
          return (0, _debitvoucher.decreptionDebit)(createdata.rows, 'array', data.data.email);
        case 7:
              ...
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  ...
                  case 10:
                    ...
                    _context5.next = 14;
                    return _debitVoucher["default"].update({
                  ...
                  case 63:
                    _context5.next = 65;
                    return _debitVoucher["default"].count({
                      where: _defineProperty({}, Op.and, [{
                        current_year: data.current_year
                      }, {
                        end_year: data.end_year
                  ...
                  case 121:
                    ...
                    _context5.next = 124;
                    return _debitVoucher["default"].create(data, {
                      transaction: t
                    });
                  case 124:
                    createdata = _context5.sent;
                    _entry["default"].createData(data.company_id, _entryMessage["default"].debit_note_create);
  ...
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(id, data, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 14:
          _context7.next = 16;
          return _debitVoucher["default"].destroy({
            where: {
              uid: id
            }
          });
            ...
            var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(t) {
              ...
              return _regeneratorRuntime().wrap(function _callee8$(_context8) {
                while (1) switch (_context8.prev = _context8.next) {
                  ...
                  case 44:
                    _context8.next = 46;
                    return _entry["default"].createData(data.company_id, _entryMessage["default"].debit_note_update);
                  case 46:
                    if (!(itemData.length > 0)) {
                      _context8.next = 55;
                      break;
                  ...
                  case 78:
                    _context8.next = 80;
                    return (0, _debitvoucher.decreptionDebit)(updatedata, 'object', data.data.email);
                  case 80:
              ...
              return _regeneratorRuntime().wrap(function _callee10$(_context10) {
                while (1) switch (_context10.prev = _context10.next) {
                  case 0:
                    ...
                    data.total_amount = '0';
                    _context10.next = 19;
                    return (0, _debitvoucher.encreptionDebit)(data, data.data.email);
                  case 19:
