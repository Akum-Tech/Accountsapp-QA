    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _context.next = 7;
          return (0, _receiptvoucher.decreptionReceipt)(createdata, 'object', data.data.email);
        case 7:
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          _context3.next = 7;
          return (0, _receiptvoucher.decreptionReceipt)(createdata, 'array', data.data.email);
        case 7:
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _recieptVoucher["default"].findAndCountAll({
            limit: data.limit,
            offset: data.offset,
            where: {
              company_id: data.company_id,
        ...
        case 3:
          ...
          _context4.next = 7;
          return (0, _receiptvoucher.decreptionReceipt)(createdata.rows, 'array', data.data.email);
        case 7:
              ...
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  ...
                  case 10:
                    ...
                    _context5.next = 14;
                    return _recieptVoucher["default"].update({
                  ...
                  case 63:
                    _context5.next = 65;
                    return _recieptVoucher["default"].count({
                      where: _defineProperty({}, Op.and, [{
                        current_year: data.current_year
                      }, {
                        end_year: data.end_year
                  ...
                  case 79:
                    ...
                    _context5.next = 85;
                    return _recieptVoucher["default"].create(data, {
                      transaction: t
                    });
                  case 85:
                    createdata = _context5.sent;
                    _entry["default"].createData(data.company_id, _entryMessage["default"].receipt_create);
                    _context5.next = 89;
                    return (0, _receiptvoucher.decreptionReceipt)(createdata, 'object', data.data.email);
                  case 89:
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 7:
          ...
          _context7.next = 10;
          return _recieptVoucher["default"].destroy({
            where: {
              uid: id
            }
          });
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 9:
          ...
          _entry["default"].createData(data.company_id, _entryMessage["default"].receipt_update);
          if (!updatedata) {
            _context8.next = 18;
            break;
          }
          _context8.next = 14;
          return (0, _receiptvoucher.decreptionReceipt)(updatedata, 'object', data.data.email);
        case 14:
              ...
              return _regeneratorRuntime().wrap(function _callee9$(_context9) {
                while (1) switch (_context9.prev = _context9.next) {
                  case 0:
                    ...
                    data.total_amount = '0';
                    _context9.next = 15;
                    return (0, _receiptvoucher.encreptionReceipt)(data, data.data.email);
                  case 15:
                    data = _context9.sent;
                    _context9.next = 18;
                    return _recieptVoucher["default"].findOne({
