...
var _company_bank = _interopRequireDefault(require("../models/company_bank"));
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          console.log(id);
          _context.next = 4;
          return _company_bank["default"].findAll({
            where: {
              company_id: id
            }
          });
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _company_bank["default"].findOne({
            where: {
        ...
        case 10:
          data.uid = _context2.sent;
          data.creation_date = new Date();
          data.updated_date = new Date();
          _context2.next = 15;
          return _company_bank["default"].create(data);
        case 15:
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          console.log(id);
          _context3.next = 4;
          return _company_bank["default"].destroy({
            where: {
              uid: id
            }
          });
        case 4:
          deleteComapnydata = _context3.sent;
