    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          _context.next = 7;
          return (0, _salesvoucher.decreptionSale)(createdata, 'object', data.data.email);
        case 7:
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          ...
          _context3.next = 7;
          return (0, _salesvoucher.decreptionSale)(createdata, 'array', data.data.email);
        case 7:
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _saleVoucher["default"].findAndCountAll({
            limit: data.limit,
            offset: data.offset,
            where: {
              company_id: data.company_id,
        ...
        case 3:
          ...
          _context4.next = 7;
          return (0, _salesvoucher.decreptionSale)(createdata.rows, 'array', data.data.email);
        case 7:
              ...
              return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                while (1) switch (_context5.prev = _context5.next) {
                  ...
                  case 10:
                    ...
                    _context5.next = 14;
                    return _saleVoucher["default"].update({
                  ...
                  case 65:
                    _context5.next = 67;
                    return _saleVoucher["default"].count({
                      where: _defineProperty({}, Op.and, [{
                        current_year: data.current_year
                      }, {
                        end_year: data.end_year
                  ...
                  case 123:
                    ...
                    _context5.next = 126;
                    return _saleVoucher["default"].create(data, {
                      transaction: t
                    });
                  case 126:
                    createdata = _context5.sent;
                    _entry["default"].createData(data.company_id, _entryMessage["default"].sale_create);
...
exports.deleteData = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(id, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 14:
          _context7.next = 16;
          return _saleVoucher["default"].destroy({
            where: {
              uid: id
            }
          });
...
function updateItemInteries(_x30, _x31, _x32, _x33, _x34) {
...
function updateTaxInteries(_x35, _x36, _x37, _x38, _x39) {
...
function updateVoucherInteries(_x40, _x41, _x42, _x43, _x44) {
    ...
    return _regeneratorRuntime().wrap(function _callee17$(_context17) {
      while (1) switch (_context17.prev = _context17.next) {
        ...
        case 13:
          ...
          _context17.t1 = data.dataValues.uid;
          _context17.t2 = findtax.dataValues.uid;
          _context17.t3 = voucher[i].amount;
          _context17.t4 = voucher[i].type;
          _context17.t5 = data.dataValues.invoice_date;
          _context17.t6 = new Date();
          ...
          return {
            uid: _context17.t0,
            voucher_id: _context17.t1,
            ledger_id: _context17.t2,
            amount: _context17.t3,
            type: _context17.t4,
            invoice_date: _context17.t5,
            status: 1,
            creation_date: _context17.t6,
            updated_date: _context17.t7,
            data: _context17.t8
          };
        case 24:
        ...
        case 34:
          ...
          _context17.t10 = companydata.dataValues.uid;
          _context17.t11 = voucher[i].sale_type === "local" ? "Sale Local @ " + voucher[i].percentage + "%" : "Sale Interstate @ " + voucher[i].sale_percentage + "%";
          _context17.t12 = _config["default"].sale_account_id;
          _context17.t13 = voucher[i].sale_type === "local" ? voucher[i].percentage : voucher[i].sale_percentage;
          _context17.t14 = companydata.dataValues.current_period_start;
          _context17.t15 = companydata.dataValues.current_period_end;
          _context17.t16 = new Date();
          _context17.t17 = new Date();
          _context17.t18 = {
            email: key
          };
          _context17.next = 46;
          return {
            uid: _context17.t9,
            company_id: _context17.t10,
            name: _context17.t11,
            account_group_id: _context17.t12,
            sale_key: _context17.t13,
            period_start: _context17.t14,
            period_end: _context17.t15,
            opening_balance: 'credit',
            amount: '0',
            is_default_bank: "false",
            cess: false,
            is_auto: true,
            status: 1,
            creation_date: _context17.t16,
            updated_date: _context17.t17,
            data: _context17.t18
          };
        case 46:
        ...
        case 52:
          ...
          return (0, _uniqid["default"])();
        case 56:
          _context17.t19 = _context17.sent;
          _context17.t20 = data.dataValues.uid;
          _context17.t21 = voucher[i].amount;
          _context17.t22 = data.dataValues.uid;
          _context17.t23 = voucher[i].type;
          _context17.t24 = data.dataValues.invoice_date;
          _context17.t25 = new Date();
          _context17.t26 = new Date();
          _context17.t27 = {
            email: key
          };
          _context17.next = 67;
          return {
            uid: _context17.t19,
            voucher_id: _context17.t20,
            amount: _context17.t21,
            ledger_id: _context17.t22,
            type: _context17.t23,
            invoice_date: _context17.t24,
            status: 1,
            creation_date: _context17.t25,
            updated_date: _context17.t26,
            data: _context17.t27
          };
        case 67:
            ...
            var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(t) {
              ...
              return _regeneratorRuntime().wrap(function _callee8$(_context8) {
                while (1) switch (_context8.prev = _context8.next) {
                  ...
                  case 44:
                    _context8.next = 46;
                    return _entry["default"].createData(data.company_id, _entryMessage["default"].sale_update);
                  case 46:
                    if (!(itemData.length > 0)) {
                      _context8.next = 55;
                      break;
                  ...
                  case 77:
                    _context8.next = 79;
                    return (0, _salesvoucher.decreptionSale)(updatedata, 'object', data.data.email);
                  case 79:
              ...
              return _regeneratorRuntime().wrap(function _callee10$(_context10) {
                while (1) switch (_context10.prev = _context10.next) {
                  case 0:
                    ...
                    _context10.next = 21;
                    return (0, _salesvoucher.encreptionSale)(data, data.data.email);
                  case 21:
