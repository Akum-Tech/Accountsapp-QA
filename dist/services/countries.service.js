...
var _countries = _interopRequireDefault(require("../models/countries"));
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _countries["default"].findOne({
            where: {
              id: id
            }
          });
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _countries["default"].findAll(data);
        case 3:
      ...
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          return _context3.abrupt("return", {
            ...
            country: _context3.t1
          });
        case 12:
          _context3.next = 14;
          return _countries["default"].create(data);
        case 14:
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _countries["default"].destroy({
            where: {
              id: id
            }
          });
