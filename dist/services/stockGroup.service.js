    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _stockGroup["default"].findOne({
            where: {
              uid: id
            }
          });
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _stockGroup["default"].findAll({
            where: {
              company_id: cid
            }
          });
...
exports.getAllDataGroups = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(cid, res) {
    var createdata;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return _database.sequelize.query("SELECT `uid`,`stock_name`,null as stock_id FROM `stock_groups` WHERE company_id=:id union SELECT `uid`,`stock_name`,stock_id from stock_sub_groups where company_id=:id", {
            replacements: {
              id: cid
            },
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 13:
          ...
          _context4.next = 18;
          return _stockGroup["default"].create(data);
        case 18:
          ...
          _entry["default"].createData(createdata.dataValues.company_id, _entryMessage["default"].stock_create);
          return _context4.abrupt("return", {
            statusCode: res.statusCode,
            success: true,
  ...
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(id, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 6:
          _context5.next = 8;
          return _stockGroup["default"].destroy({
            where: {
              uid: id
            }
          });
