    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _stockSubGroup["default"].findOne({
            where: {
              uid: id
            }
          });
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _stockSubGroup["default"].findAll({
            where: {
              company_id: cid
            },
            include: [{
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 13:
          ...
          _context3.next = 18;
          return _stockSubGroup["default"].create(data);
        case 18:
          ...
          _entry["default"].createData(createdata.dataValues.company_id, _entryMessage["default"].sub_stock_create);
          return _context3.abrupt("return", {
            statusCode: res.statusCode,
            success: true,
  ...
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 6:
          _context4.next = 8;
          return _stockSubGroup["default"].destroy({
            where: {
              uid: id
            }
          });
