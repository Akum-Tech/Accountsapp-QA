...
// Encrypt
var ciphertext = _cryptoJs["default"].AES.encrypt('my message', 'secret key 123');
console.log(ciphertext.toString());
// Decrypt
var bytes = _cryptoJs["default"].AES.decrypt(ciphertext.toString(), 'secret key 123');
var plaintext = bytes.toString(_cryptoJs["default"].enc.Utf8);
