    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _organizationInfo["default"].findOne({
            where: {
              uid: id
            }
          });
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 8:
          ...
          _context3.next = 12;
          return _organizationInfo["default"].create(data);
        case 12:
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          _context4.next = 3;
          return _organizationInfo["default"].destroy({
            where: {
              id: id
            }
          });
        case 3:
          deleteComapnydata = _context4.sent;
        ...
        case 10:
          ...
          _context4.t1 = deletedata;
          return _context4.abrupt("return", {
            statusCode: _context4.t0,
            success: false,
            message: "Something went wrong!",
            company: _context4.t1
          });
        case 13:
          _context4.next = 22;
          break;
